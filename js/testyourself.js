...
var Tools = {
    ...
    getImageUrl: function(n) {
        ...
        if (!i) return !1;
        var u = "/" + n.GameId + "/" + i;
        return t = document.location.host.indexOf("localhost") >= 0 ? "teststorage" : "cdn", r + "/especiales/dia-de-la-madre-trivia-nndd-ecvisual-ecpm/" + t + u
    },
    ...
    storage: function() {
        if ($.store) {
            ...
            function r() {
                if (window.gameData) i = "/especiales/dia-de-la-madre-trivia-nndd-ecvisual-ecpm/" + gameData.gameId;
                else return;
                t = !0
            }
    ...
    window.Comm || (window.Comm = {
        ...
        APIs: function() {
            ...
            if (u.indexOf("localhost.playbuzz.com") >= 0) return {
                ...
                baseImageUrl: function() {
                    if (window.Tools) {
                        ...
                        if (n) return "/especiales/dia-de-la-madre-trivia-nndd-ecvisual-ecpm/"
                    }
                    return window.cdnUrl ? "//" + window.cdnUrl : "/especiales/dia-de-la-madre-trivia-nndd-ecvisual-ecpm/"
                }()
            };
            var i = {};
            ...
            return {
                ...
                baseImageUrl: window.cdnUrl ? n + "//" + window.cdnUrl : n + "/especiales/dia-de-la-madre-trivia-nndd-ecvisual-ecpm/"
            }
        }(),
...
(function startQuiz() {
    ...
    window.onAmazonResultClicks = function(n, t, i) {
        ...
        window.ga && ga("send", "event", r + " – results", n, t);
        i && window.open(i)
    };
